...
/* This version is not implementing Reader/Writer accesses to tuples */
public class LegacyCentralizedLinda implements Linda {
	...
	public String status() {
		...
		// General
		sb.append("LegacyCentralizedLinda\n-----------------------------------");
