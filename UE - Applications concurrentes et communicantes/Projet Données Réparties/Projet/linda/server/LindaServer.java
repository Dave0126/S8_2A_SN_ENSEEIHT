...
public interface LindaServer extends Remote {
    ...
    /** Adds specified server in neighbors list (Multiserver prupose) */
    public void addNeighbor(LindaServer neighbor) throws RemoteException;
    
    /** Returns status and/or any informations it wants for monitoring purposes */
