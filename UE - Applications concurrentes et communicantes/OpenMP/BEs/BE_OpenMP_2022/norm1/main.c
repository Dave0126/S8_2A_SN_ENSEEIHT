...
./main 50 50
  Result:
              ...
              Sequential  --  norm: 28.7516   time (usecs):    26

  (1 thread)  Col-major   --  norm: 28.7516   time (usecs):   704
  (1 thread)  Row-major   --  norm: 28.7516   time (usecs):   240

  (2 threads) Col-major   --  norm: 28.7516   time (usecs):   531
  (2 threads) Row-major   --  norm: 28.7516   time (usecs):   534

  (4 threads) Col-major   --  norm: 28.7516   time (usecs):  1899
  (4 threads) Row-major   --  norm: 28.7516   time (usecs):  1090

  Accordng to the result of test, Col-major version is the fastest one.
*/
