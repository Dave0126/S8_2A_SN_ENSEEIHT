...
\begin{document}
\tlatex
\fl{}\moduleLeftDash\cl{ {\MODULE} philosophes0}\moduleRightDash\cl{}
\fl{}
\fl{}
\fl{ {\EXTENDS} Naturals}
\fl{}
\fl{ {\CONSTANT} N}
\fl{}
\fl{ {\ASSUME} N \.{\in} Nat \.{\land} N \.{>} 1}
\fl{}
\fl{ Philos \.{\defeq} 0 \.{\dotdot} N \.{-} 1}
\fl{}
 \fl{ gauche ( i )}\al{11}{4}{ \.{\defeq}}\al{11}{5}{ ( i}\al{11}{7}{
 \.{+}}\al{11}{8}{ 1 ) \.{\%} N}\al{11}{12}{%
\@y{\@s{0}%
 philosophe à gauche du philo n°\ensuremath{i
}}%
}
 \fl{ droite ( i )}\al{12}{4}{ \.{\defeq}}\al{12}{5}{ ( i}\al{12}{7}{
 \.{+}}\al{12}{8}{ N \.{-} 1 ) \.{\%} N}\al{12}{14}{%
\@y{\@s{0}%
 philosophe à \ensuremath{droite} du philo n°\ensuremath{i
}}%
}
\fl{}
\fl{ Hungry \.{\defeq}\@w{H}}
\fl{ Thinking \.{\defeq}\@w{T}}
\fl{ Eating \.{\defeq}\@w{E}}
\fl{}
\fl{ {\VARIABLES}}
\fl{ etat ,\,%
\@y{\@s{0}%
 \ensuremath{i \.{\rightarrow}
 Hungry},\ensuremath{Thinking},\ensuremath{Eating
}}%
}
\fl{ jeton}
\fl{}
 \fl{ TypeInvariant \.{\defeq} {\Box} ( etat \.{\in} [ Philos \.{\rightarrow}
 \{ Hungry ,\, Thinking ,\, Eating \} ] )}
\fl{}
\fl{}
\fl{}
 \fl{ ExclusionMutuelle \.{\defeq} {\Box} ( \A\, i \.{\in} Philos \.{:} etat [
 i ] \.{=} Eating \.{\implies} ( etat [ gauche ( i ) ] \.{\neq} Eating
 \.{\land} etat [ droite ( i ) ] \.{\neq} Eating ) )}
\fl{}
 \fl{ AbsenceDeFamine \.{\defeq} \A\, i \.{\in} Philos \.{:} {\Box} ( etat [ i
 ] \.{=} Hungry \.{\implies} {\Diamond} ( etat [ i ] \.{=} Eating ) )}
\fl{}
 \fl{ Sanity \.{\defeq} {\Box} ( \A\, i \.{\in} Philos \.{:} etat [ i ] \.{=}
 Eating \.{\implies} jeton \.{=} i )}
\fl{}
 \fl{ JetonVaPartout \.{\defeq} \A\, i \.{\in} Philos \.{:} {\Box} {\Diamond}
 ( jeton \.{=} i )}
\fl{}
\fl{}\midbar\cl{}
\fl{}
\fl{ Init}\al{36}{1}{ \.{\defeq}%
\@y{\@s{0}%
 À changer
}%
}
 \fl{ \.{\land}}\al{37}{1}{ etat \.{=} [ i \.{\in} 0 \.{\dotdot} N \.{-} 1
 \.{\mapsto} Thinking ]}
\fl{ \.{\land}}\al{38}{1}{ jeton \.{\in} Philos}
\fl{}
\fl{}
\fl{ demande ( i ) \.{\defeq}}\al{41}{5}{%
\@y{\@s{0}%
 À changer
}%
}
\fl{ \.{\land}}\al{42}{1}{ etat [ i ] \.{=} Thinking}
 \fl{ \.{\land}}\al{43}{1}{ etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ]
 \.{=} Hungry ]}
\fl{ \.{\land}}\al{44}{1}{ {\UNCHANGED} jeton}
\fl{}
\fl{ mange ( i )}\al{46}{4}{ \.{\defeq}}\al{46}{5}{%
\@y{\@s{0}%
 À changer
}%
}
\fl{ \.{\land} etat [ i ] \.{=} Hungry}
\fl{}
 \fl{ \.{\land}}\al{49}{1}{ etat [ gauche ( i ) ]}\al{49}{8}{
 \.{\neq}}\al{49}{9}{ Eating}
 \fl{ \.{\land}}\al{50}{1}{ etat [ droite ( i ) ]}\al{50}{8}{
 \.{\neq}}\al{50}{9}{ Eating}
\fl{ \.{\land}}\al{51}{1}{ jeton}\al{51}{2}{ \.{=}}\al{51}{3}{ 1}
 \fl{ \.{\land}}\al{52}{1}{ etat \.{'}}\al{52}{3}{ \.{=}}\al{52}{4}{ [ etat
 {\EXCEPT} {\bang} [ i ] \.{=} Eating ]}
\fl{ \.{\land}}\al{53}{1}{ {\UNCHANGED} jeton}
\fl{}
\fl{ pense ( i )}\al{55}{4}{ \.{\defeq}%
\@y{\@s{0}%
 À changer
}%
}
\fl{ \.{\land}}\al{56}{1}{ etat [ i ] \.{=} Eating}
 \fl{ \.{\land}}\al{57}{1}{ etat \.{'} \.{=} [ etat {\EXCEPT} {\bang} [ i ]
 \.{=} Thinking ]}
\fl{ \.{\land}}\al{58}{1}{ {\UNCHANGED} jeton}
\fl{}
\fl{ bouger ( i ) \.{\defeq}}\al{60}{5}{ \.{\land}}\al{60}{6}{ jeton \.{=} i}
\fl{ \.{\land}}\al{61}{1}{ etat [ i ] \.{\notin} \{ Hungry ,\, Eating \}}
\fl{ \.{\land}}\al{62}{1}{ jeton \.{'} \.{=} ( i \.{+} 1 ) \.{\%} N}
\fl{ \.{\land}}\al{63}{1}{ {\UNCHANGED} etat}
\fl{}
\fl{ Next \.{\defeq}}
 \fl{ \E\, i \.{\in} Philos \.{:}}\al{66}{5}{ \.{\lor}}\al{66}{6}{ demande ( i
 )}
\fl{ \.{\lor}}\al{67}{1}{ mange ( i )}
\fl{ \.{\lor}}\al{68}{1}{ pense ( i )}
\fl{ \.{\lor}}\al{69}{1}{ bouger ( i )}
\fl{}
\fl{ Fairness \.{\defeq}}\al{71}{2}{%
\@y{\@s{0}%
 À changer
}%
}
 \fl{ \A\, i \.{\in} 0 \.{\dotdot} N \.{-} 1 \.{:} {\SF}_{ {\langle} etat
 {\rangle}} ( mange ( i ) ) \.{\land} {\WF}_{ {\langle} etat {\rangle}} (
 pense ( i ) )}
\fl{}
\fl{}
\fl{ Spec}\al{75}{1}{ \.{\defeq}}
\fl{ \.{\land}}\al{76}{1}{ Init}
\fl{ \.{\land}}\al{77}{1}{ {\Box} [ Next ]_{ {\langle} etat {\rangle}}}
\fl{ \.{\land}}\al{78}{1}{ Fairness}
\fl{}
\fl{}\bottombar\cl{}
\end{document}
